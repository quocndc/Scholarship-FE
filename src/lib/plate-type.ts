...
import type { BulletedListPlugin, ListItemPlugin, NumberedListPlugin, TodoListPlugin } from '@udecode/plate-list/react';
...
import { type ParagraphPlugin, useEditorRef } from '@udecode/plate-common/react';
...
export type MyEditor = ReturnType<typeof useEditor>;
