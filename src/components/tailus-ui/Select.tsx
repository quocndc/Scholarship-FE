...
import { caption, select, trigger, type SelectProps, type SeparatorProps, type TriggerProps } from '@tailus/themer';
...
>(({ className, children, ...props }, forwardedRef) => (
  <SelectPrimitive.ScrollUpButton {...props} ref={forwardedRef} className={button({ className })}>
    {children || <IconChevronUp className="size-3" />}
...
>(({ className, children, ...props }, forwardedRef) => (
  <SelectPrimitive.ScrollDownButton {...props} ref={forwardedRef} className={button({ className })}>
    {children || <IconChevronDown className="size-3" />}
