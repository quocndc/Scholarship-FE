...
const CarouselPrevious = React.forwardRef<HTMLButtonElement, ButtonProps>(({ className, variant = 'outlined', intent = 'gray', ...props }, ref) => {
...
const CarouselNext = React.forwardRef<HTMLButtonElement, ButtonProps>(({ className, variant = 'outlined', intent = 'gray', ...props }, ref) => {
